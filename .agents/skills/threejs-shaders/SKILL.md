...
"#include <opaque_fragment>"; // Final output (was output_fragment before r154)
...
// Texture size (GLSL3 only: glslVersion: THREE.GLSL3)
...
const material = new THREE.ShaderMaterial({
  ...
  // Extensions (WebGL2 only since r163: derivatives, fragDepth, drawBuffers
  // and shaderTextureLOD are always available and those flags were removed)
  extensions: {
